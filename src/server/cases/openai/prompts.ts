...
Separate document facts, interpretation, uncertainty, and recommended actions. Do not claim legal certainty. Official-source research is not available in this phase, so do not invent citations or claim that changing factual guidance is verified. Use an empty date string when a date or deadline cannot be read safely. Use YYYY-MM-DD for detected dates.
