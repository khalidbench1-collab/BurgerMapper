export function AnalysisLoadingState({ message }: { message?: string }) {
  return (
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-[#68736d]">
            {message ?? "The BurgerMapper server is validating the input and waiting for a structured OpenAI response. You can start over to cancel."}
          </p>
        </div>
      </div>
    </section>
