      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 id="analysis-loading-heading" className="text-lg font-semibold text-[#1d2b24]">
            {mode === "mock" ? "Building your demo route" : "Analyzing your case"}
          </h2>
          <p className="mt-2 text-sm leading-6 text-[#68736d]">
            {message ?? (mode === "mock"
              ? "The BurgerMapper server is validating the input in memory and applying the example scenario. Nothing is sent to an AI provider."
