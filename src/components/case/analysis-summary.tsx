  ...
  return (
    <section aria-labelledby="analysis-summary-heading" className="space-y-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <MockModeBadge mode="openai" label="OpenAI analysis" />
      ...
      <article className="rounded-2xl border border-[#e1d8c9] bg-[#fffdf8] p-5 sm:p-6">
        ...
        <h3 className="mt-2 text-xl font-semibold text-[#202c26]">
          {analysis.inputKind === "goal" ? copy.summaryFromGoal : copy.summary}
        </h3>
